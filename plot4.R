...
plot(dated$Voltage ~dated$datetime ,type="l",ylab="Voltage",xlab="datetime")
...
## Use smaller axis font to display all axis labels
plot(dated$Global_reactive_power ~dated$datetime ,type="l",ylab="Global_reactive_power",xlab="datetime",cex.axis=0.8)
dev.off()
